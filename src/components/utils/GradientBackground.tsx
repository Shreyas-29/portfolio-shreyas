...
const GradientBackground = ({ children }: { children: React.ReactNode }) => {
    ...
    return (
        <AnimationContainer customClassName="">
            <div className="min-h-screen w-full bg-[#080809]">
                ...
                <motion.div
                    ...
                    animate={controls}
                    className="bg-blue-500/30 z-[15] w-[30rem] left-[45%] top-[5rem] absolute h-[18rem] blur-[11rem] rounded-full hidden lg:flex"
                />
                <motion.div
                    initial={{ opacity: 0 }}
                    whileInView={{ opacity: 1 }}
                    ...
                    transition={{ duration: 0.2, ease: 'easeInOut' }}
                    animate={controls}
                    className="bg-indigo-500/30 z-[15] absolute w-[30rem] right-[45%] top-[5rem] h-[18rem] mt-[5rem] blur-[11rem] rounded-full hidden lg:flex"
                />
